...
def run():
    ...
    st.markdown(
        """
        Welcome to my statistics on Anime Music Quiz (AMQ), a popular quiz game developed by Egerod. 
        This site is not affiliated with AMQ or Egerod, but it uses data from an improved version of the AMQ database that I maintain. 
        
        I also use AMQ ranked data collected by [blissfulyoshi](https://github.com/blissfulyoshi) for anything related to ranked.
        ...
        I hope you enjoy! Please let me know if you have any questions or feedback.
        """
    )
